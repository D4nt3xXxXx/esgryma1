    ...
    <div class="relative">
        <div class="vx-navbar-wrapper navbar-full p-0">
            <vs-navbar class="navbar-custom navbar-skelton" :class="navbarClasses" :style="navbarStyle"
                       :color="navbarColor">
                <router-link tag="div" to="/app/index" class="vx-logo cursor-pointer">
                    <logo class="mr-4 fill-current text-primary" style="width: 160px"/>
                    <!--<span class="vx-logo-text text-primary">Esgryma</span>-->
                </router-link>

               <!-- <bookmarks :navbarColor="navbarColor" v-if="windowWidth >= 992"/> -->
                <router-link tag="div" to="/app/index" class="vx-logo cursor-pointer mx-auto flex items-start">
