...
<template>
    <div id="dashboard-analytics">
        <div class="vx-row">
            <!--<vs-button color="primary" type="filled" :href="{url: '/app/pages/'}">Pagina de error</vs-button>
            <vs-button v-if="isRole('administrador')" type="gradient" @click="consultarUsuarios">COnsultar usuarios</vs-button>-->
            <!-- CARD 1: CONGRATS -->
