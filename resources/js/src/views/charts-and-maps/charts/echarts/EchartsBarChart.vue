...
<template>
    <vx-card title="Cumplimiento asesor" class="mb-base" code-toggler>
        ...
        return {
            bar: {
                ...
                dataset: {
                    // Provide data.
                    source: [
                        ['Product', 'Asigandas', 'Programadas'],
                        ['Diana E.', ...this.randomize()],
                        ['Luz A.', ...this.randomize()],
                        ['Alba R.', ...this.randomize()],
                        // ['Walnut Brownie', ...this.randomize()]
                    ]
                },
                // Declare X axis, which is a category axis, mapping
    ...
    methods: {
        randomize() {
            return [
                ...
                Math.round((300 + Math.random() * 700) / 10)/4,
                // Math.round(300 + Math.random() * 700) / 10
            ]
        }
    },
