...
<template>
    <div class="px-6 pb-2 pt-6">
        <a class="vs-button vs-button-primary" style="background-color: rgb(255, 159, 67);color: white;" target="_blank"
           href="/app/agenda">
            Ver agenda
        </a>
        <vs-prompt
                            ...
                            <vs-dropdown class="cursor-pointer flex" vs-custom-content>
                                ...
                                <vs-dropdown-menu style="z-index: 200001">
                                    <vs-dropdown-item v-for="(tag, index) in taskTags" :key="index">
                                        <vs-checkbox @click.stop :vs-value="tag.value" v-model="taskLocal.tags">{{
                                            tag.text }}
                                        </vs-checkbox>
                                    </vs-dropdown-item>
                                </vs-dropdown-menu>
...
<script>
    export default {
        ...
        computed: {
            ...
            validateForm() {
                return true//!this.errors.any() && this.taskLocal.title != ''
            }
        },
        methods: {
            clearFields() {
