<template>
    <div>
        ...
        <vs-button :disabled="loading"
                   @click="sendNotification" type="filled">Enviarme una notificación</vs-button>
        <!-- Enable/Disable push notifications -->
        <vs-button :disabled="pushButtonDisabled || loading"
                   :class="{ 'vs-button-info': !isPushEnabled, 'vs-button-danger': isPushEnabled }"
                   @click="togglePush" type="filled">{{ isPushEnabled ? 'Denegar' : 'Permitir' }} notificación</vs-button>
    </div>
</template>
